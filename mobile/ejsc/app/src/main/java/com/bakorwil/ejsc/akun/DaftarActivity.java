...
public class DaftarActivity extends AppCompatActivity {
    ...
    private void kirimDataRegistrasi() {
        ...
        if (nik.getText().toString().isEmpty()) {
            ...
            StringRequest senddata = new StringRequest(Request.Method.POST, ServerApi.URL_DAFTAR, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (res.getBoolean("status")) {
                            ...
                            Intent moving = new Intent(DaftarActivity.this, LoginActivity.class);
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(DaftarActivity.this, "Gagal Register, " + error, Toast.LENGTH_SHORT).show();
                        }
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("foto_ktp", "fotoktp.jpg");
