...
public class ServerApi {
    ...
    public static final String URL_KONTAK = "http://192.168.1.6/EJSC_Project/admin/api/kontak/kontak";
    // Rest API Ruangan
    public static final String URL_RUANGAN = "http://192.168.1.6/EJSC_Project/admin/api/ruangan/ruangan";
}
