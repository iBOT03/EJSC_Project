...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2020 at 02:05 PM
...
('1', '1', 'BKPM TIF 4 - Describing Things related to IT.pdf', 'Admin', 'admin@admin.com', '000', 'admin', '', 'asdasdasd'),
('12121213', '1', 'BKPM TIF 4 - Describing Things related to IT.pdf', 'asdad', 'aaa@gmail.com', '12312312312', '12313', '', 'pppppppp'),
('12315', '2', 'BKPM TIF 4 - Describing Things related to IT.pdf', 'asdasd', 'asdadad@gmail.com', '123123123', 'asd', 'Sahabat Nur', 'asdasdasd'),
('12321', '2', 'Kelompok 4 - Design Sprint(Understand).pdf', '123', 'qqq@qqq.com', '0918398173987', 'qqq', 'Komunitas Musisi Jember', 'pppppppp'),
('1234567890098', '1', 'Kelompok 4 - Design Sprint(Understand).pdf', 'Octavian Yudha Mahendra', 'yudhaoctavian01@gmail.com', '081252989930', 'Jl. Nangka 4/9 Perumnas Patrang Jember', '', 'asdasdasd'),
('2', '1', '', 'Admin 2', 'admin2@admin.com', '0000', 'admin 2', '', 'asdasdasd'),
('3500000000000005', '2', '', 'Aku User', 'user@gmail.com', '123456789012', 'alamat user', 'komunitas user', '1234'),
('3529010308000005', '1', 'user.png', 'Andrea Santana Adzani', 'andrea.santana986@gmail.com', '0987239461909', 'Jl. Sagitarius No. 34 Satelit Sumenep', '', 'sagitarius'),
('3529010308000010', '2', 'TIF_18A_Kelompok_4_Ide_Wirausaha.pdf', 'Aris Febriansyah', 'arisfebri@gmail.com', '098098098098', 'asd', 'Coding', 'asdasdasd'),
('4444465', '2', 'Kelompok 4 - Design Sprint (Diverge and Decide).docx.pdf', 'tessssss', 'tesss@gmail.com', '96959483', 'tes', 'Coding', '$2y$10$K7RrT40nI'),
('65746329293773', '1', 'Kelompok 4 - Design Sprint(Understand).pdf', 'Admin 3', 'admin3@gmail.com', '0918398173987', 'admin 3', '', '$2y$10$mTyCUQxmg'),
('7777', '2', 'BKPM TIF 4 - Describing Things related to IT.pdf', 'user 2', 'user2@gmail.com', '0918398173987', 'user 2', 'Coding', '$2y$10$pryc6mIAX');
...
(5, 'logo.png', 'sahabatnur@gmail.com', 'Sahabat Nur', '3', 'asdasdasd', 'Andrea S A', 'asdasdasd', '09809809808', 'asdasd', 'asdasd', 'asdasd');
...
('ejscjember@gmail.com', 1, '089798987', '085749806996', 'ejsc jember', 'ejscjember', 'Jl. Kalimantan            ');
...
--
ALTER TABLE `alat`
  MODIFY `ID_ALAT` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
